...
- [x] Pagina home
- [x] Pagina di visualizzazione ricette totali
- [x] Pagina di registrazione
- [x] Pagina di login
    - [x] Pulsante di logout
- [x] Area personale per utenti registrati
    - [x] Pagina di inserimento ricetta
        - [x] Inserimento ingredienti
        - [x] Inserimento categoria
    - [x] Pagina di Modifica ricetta
    - [x] Pulsante di eliminazione ricetta per autore della stessa
- [x] Pagina di visualizzazione ricetta
    - [x] Visualizzazione data di inserimento
    - [x] Visualizzazione categoria
    - [x] Visualizzazione degli ingredienti
...
- [] Ruolo di amministratore
    - [] Area amministrativa
        - [] Elenco degli utenti e status
    - [] Disabilitazione degli account
    - [] Eliminazione (non modifica) delle recensioni

- [] Possibili modifiche
    - [] Aggiunta "data ultima modifica" alla pagina della ricetta
    - [] Aggiunta "valutazione generale" alla pagina della ricetta
